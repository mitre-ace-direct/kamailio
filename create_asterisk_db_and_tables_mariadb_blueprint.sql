...
GRANT ALL PRIVILEGES ON asterisk.* TO 'asterisk'@'%' IDENTIFIED BY 'DBPW';
GRANT ALL PRIVILEGES ON asterisk.* TO 'asterisk'@'localhost' IDENTIFIED BY 'DBPW';
GRANT ALL PRIVILEGES ON asterisk.* TO 'kamailio'@'%' IDENTIFIED BY 'DBPW';
GRANT ALL PRIVILEGES ON asterisk.* TO 'kamailio'@'localhost' IDENTIFIED BY 'DBPW';
